...
if(defined('INNER_PAGE') and isset($_REQUEST['slug'])) {
	...
	if(!empty($recRow)) {
	    ...
	    <!-- Section About Promo -->
	    <div class="section">
	        <div class="widget-about-promo" data-background="'.$imglink.'">
	            <div class="wrapper-inner">
	                <div class="widget-inner">
	                    <div class="row">
	                        ...
	                        if($imgcount>1){
	                         $resinndetail.='<div class="col-md-6 owl-slider owl-theme">';
	                       
		                        foreach($imageList as $image) {
		                        	$resinndetail.='<img class="item" src="'.BASE_URL.'images/articles/'.$image.'">';
		                        }
		                        $resinndetail.='</div>';
	                        }
	                    $resinndetail.='</div>
