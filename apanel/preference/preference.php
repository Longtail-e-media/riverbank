    	...
    	<form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                    ...
                    <?php if (!empty($PrefeRow->other_upload)): ?>
                        <div class="col-md-2" id="removeSavedimg7">
                            ...
                            <span class="float-left">
                                ...
                                <?php $imagename=$PrefeRow->other_upload;
                                $zipname= explode('.', $imagename);
                                // pr($zipname);?>
                                <span><?php echo $PrefeRow->other_upload; ?></span>
                    ...
                    <div class="form-input col-md-10 uploader7 <?php echo !empty($PrefeRow->other_upload) ? "hide" : ""; ?>">
                        ...
                        <label><small>Image Dimensions 100 px X 100 px)</small>
                    </label>
                    </div>
                    <!-- Upload user image preview -->
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10">
                    <select class="col-md-2 book_type" name="book_type">
                        ...
                        <option value="2" <?php echo (!empty($PrefeRow->book_type) and $PrefeRow->book_type==2)?'selected':'';?>>rojai</option>
   ...
   // <![CDATA[
	$(document).ready(function() {
	  ...
	  $('#other_upload').uploadify({
            'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
            'uploader': '<?php echo ASSETS_PATH;?>uploadify/uplodifyemail.php',
            'formData': {
