            ...
            <form action="" class="col-md-12 center-margin" id="combined_frm">
                ...
                <div class="form-row add-home-image">
                    ...
                    <div class="form-input col-md-10 home_uploader <?php echo !empty($combinednewsInfo->home_image) ? "hide" : ""; ?>">
                        ...
                        <label><small>Image Dimensions (395 px X 263 px)</small></label>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10 uploader4 <?php echo !empty($combinednewsInfo->fb_upload) ? "hide" : ""; ?>">
                    ...
                    <?php if (!empty($combinednewsInfo->fb_upload)): ?>
                        <div class="col-md-2" id="removeSavedimg4">
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                                <span class="float-left">
                                    <?php
                                    if (file_exists(SITE_ROOT . "images/combinednews/social/" .$combinednewsInfo->fb_upload)):
                                        $filesize = filesize(SITE_ROOT . "images/combinednews/social/" .$combinednewsInfo->fb_upload);
                                        echo 'Size : ' . getFileFormattedSize($filesize);
                                    endif;
                                    ?>
                                </span>
                                    <a class="btn small float-right" href="javascript:void(0);"
                                    onclick="deleteSavedCombinedNewsimage(4);">
                                        <i class="glyph-icon icon-trash-o"></i>
                                    </a>
                                </div>
                                <img src="<?php echo IMAGE_PATH . 'combinednews/social/thumbnails/' . $combinednewsInfo->fb_upload; ?>"
                                    style="width:100%"/>
                                <input type="hidden" name="imageArrayname4" value="<?php echo $combinednewsInfo->fb_upload; ?>"/>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                            <small>Image Dimensions (1920 px X 600 px)</small>
                        </label>
                    </div>
                    <!-- Upload user image preview -->
    ...
    "@graph": [
        ...
        },
        {
            ...
            "url": "' . BASE_URL . '/clubhimalaya/"
                ...
                $_faqRaw = isset($combinednewsInfo->faq_schema) ? trim((string)$combinednewsInfo->faq_schema) : '';
                if ($_faqRaw !== '') {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#fb_upload').uploadify({
                ...
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/combinednews/social/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/combinednews/uploaded_fb_image.php', {imagefile: filename}, function (msg) {
