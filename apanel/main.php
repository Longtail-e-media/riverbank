                    ...
                    <div id="page-header" class="clearfix">
                        <div id="page-header-wrapper" class="clearfix">                           
                            ...
                            <div class="top-icon-bar">
                                ...
                                <a href="<?php echo BASE_URL?>apanel/rojai/oB514A2" class="user-ico clearfix" title="LogIn : Rojai "><span><i class="glyph-icon icon-sign-out font-size-12" style="margin: 0px !important;"></i>Online Booking</span></a>
