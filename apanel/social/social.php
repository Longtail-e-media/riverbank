    ...
    <div class="example-code">
        <form action="" class="col-md-10 center-margin" id="social_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="fa fa-icon" class="col-md-4 validate[required,length[0,200]]" type="text" name="imageArrayname" id="imageArrayname" value="<?php echo !empty($socialInfo->image)?$socialInfo->image:"";?>">
                </div>                
            </div>
