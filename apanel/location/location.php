    ...
    <div class="example-code">
    	<form action="" class="col-md-12 center-margin" id="location_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Mobile Info" class="col-md-6" type="text" name="mobile_info" id="mobile_info" value="<?php echo !empty($locationRow->mobile_info)?$locationRow->mobile_info:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Contact Info" class="col-md-6" type="text" name="whatsapp" id="whatsapp" value="<?php echo !empty($locationRow->whatsapp)?$locationRow->whatsapp:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Fiscal Address" class="col-md-6" type="text" name="city_address" id="city_address" value="<?php echo !empty($locationRow->city_address)?$locationRow->city_address:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="City Mail Address" class="col-md-6" type="text" name="city_mail_info" id="city_mail_info" value="<?php echo !empty($locationRow->city_mail_info)?$locationRow->city_mail_info:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
                    <label for="">
                        City Mobile Contact Info :
                    </label>
                </div>                
                <div class="form-input col-md-20">
                    <input placeholder="City Mobile Contact Info" class="col-md-6" type="text" name="city_contact_info" id="city_contact_info" value="<?php echo !empty($locationRow->city_contact_info)?$locationRow->city_contact_info:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
                    <label for="">
                        City Tell Contact Info :
                    </label>
                </div>                
                <div class="form-input col-md-20">
                    <input placeholder="City Tell Contact Info" class="col-md-6" type="text" name="city_tell_info" id="city_tell_info" value="<?php echo !empty($locationRow->city_tell_info)?$locationRow->city_tell_info:"";?>">
                </div>                
            </div>
            <div class="form-row">   
                <div class="form-label col-md-2">
