            ...
            <div class="hide">         
                <form action="" class="col-md-12 center-margin" id="offers-properties">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-20">
                            <input placeholder="Image Width Px." class="col-md-4 validate[required,length[0,50]] noSpaces" type="text" name="imgbwidth" id="imgbwidth" value="<?php echo Module::get_properties($moduleId,'imgbwidth');?>">
                        </div>                
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-20">
                            <input placeholder="Image Hight Px." class="col-md-4 validate[required,length[0,100]] noSpaces" type="text" name="imgbheight" id="imgbheight" value="<?php echo Module::get_properties($moduleId,'imgbheight');?>">
                        </div>                
                    </div> 
