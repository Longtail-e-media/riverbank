                ...
                <div class="form-row">                    
                    ...
                    <div class="form-input col-md-2"> 
                       <select id="type" name="type">
                           <option value="1" <?php echo (!empty($galleryInfo->type) and $galleryInfo->type=='1')?'selected':"";?>>Inner Page</option>
                           <option value="2" <?php echo (!empty($galleryInfo->type) and $galleryInfo->type=='2')?'selected':"";?>>Home Page</option>
                       </select>
                    </div>  
                </div>
                <div class="form-row">    
