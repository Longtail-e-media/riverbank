...
class Article extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'parent_id', 'slug', 'title', 'sub_title','fb_upload','linksrc', 'linktype', 'content', 'status', 'sortorder', 'meta_title', 'meta_keywords', 'meta_description', 'type', 'added_date', 'homepage', 'image');
