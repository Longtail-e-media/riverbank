...
class Config extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'sitetitle', 'icon_upload', 'logo_upload', 'sitename', 'location_type', 'other_upload','location_map', 'location_image', 'fiscal_address', 'mail_address', 'contact_info','mobile_info', 'city_mail_info','city_tell_info','city_address','city_contact_info', 'fax', 'email_address', 'breif', 'copyright', 'meta_title', 'site_keywords', 'site_description', 'google_anlytics', 'book_type', 'hotel_code', 'hotel_page', 'template', 'admin_template','headers','footer','search_box','search_result', 'action');
	...
	public $contact_info;
	public $city_address;
	public $city_contact_info;
	public $city_tell_info;
	public $city_mail_info;
	public $mobile_info;
