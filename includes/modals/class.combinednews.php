...
class CombinedNews extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        ...
        'event_endate', 'type', 'author', 'banner_image', 'source', 'meta_description', 'schema_code', 'fb_upload', 'faq_schema'
    );
    ...
    public static function getRelatednews_by($cond = '', $limit = '')
    {
        ...
        $sql = "SELECT id,title,slug,event_stdate,image,home_image, author FROM " . self::$table_name . " WHERE status=1 $cond1 ORDER BY event_stdate DESC $cond2 ";
        return self::find_by_sql($sql);
    }
