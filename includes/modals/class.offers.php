...
class Offers extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        ...
        'status', 'added_date', 'sortorder', 'type', 'offerpopup', 'list_image', 'fb_upload', 'meta_title', 'meta_keywords', 'meta_description', 'schema_code', 'faq_schema'
    );
    ...
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE status=1 ORDER BY offer_date DESC");
    }
