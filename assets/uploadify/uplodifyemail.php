...
if (!empty($_FILES)) {
    ...
    if($file_ext=='zip'){
        $targetFile = 'esignature.zip';
    }
        else{
            
            $targetFile = 'esignature';
        }
    ...
    $fileTypes = array('jpg', 'jpeg', 'gif', 'png', 'webp', 'svg','zip'); // File extensions
    ...
    if (in_array(strtolower($fileParts['extension']), $fileTypes)) {
        {
            ...
            if (in_array(strtolower($fileParts['extension']), array('jpg', 'jpeg', 'gif', 'png', 'webp','zip'))) {
