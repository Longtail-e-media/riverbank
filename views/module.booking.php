...
if($booking_type==1) {
    ...
    // Bottom link
    $resbtnlink.='<a href="'.BASE_URL.'reservation" class="btn btn-medium btn-darkbrown" target="_blank">Book now</a>';  
}
...
if($booking_type==2) {
    ...
    <div class="styleswitcher widget-slider">
        ...
        <div class="styleswitcher-inner slider-booking">
            ...
            <form action="result.php" id="default-form" target="_balnk" novalidate="novalidate">
