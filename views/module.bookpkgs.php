...
if (defined('BOOK_PAGE')) {
	...
	if (!empty($sRec)) {
		...
		$imglink = IMAGE_PATH . 'static/contact-banner.jpg';
		if (!empty($sRec->image)) {
		...
		$socialshare = '
			<div class="share-social">
            	<a class="facebook-share" target="blank" href="https://www.facebook.com/dialog/share?app_id=1103361648127921&display=popup&href=' . BASE_URL . 'offer/' . $sRec->slug . '&name=' . BASE_URL . 'offer/' . $sRec->slug . '&caption=' . BASE_URL . 'offer/' . $sRec->slug . '&description=' . BASE_URL . 'offer/' . $sRec->slug . '">
                	<i class="fa fa-facebook" aria-hidden="true"></i><span>Share</span>
				</a>
            <a class="twitter-share" target="blank" href="https://twitter.com/share?url=' . BASE_URL . 'blog/' . $sRec->slug . '&text=' . $sRec->title . '" >
	 ...
	 <section class="breadcrumb-area overlay-dark-2 bg-2" style="background-image:url(' . IMAGE_PATH . 'images/static/contact-banner.jpg); background-repeat: no-repeat; ">
		...
		if ($sRec->type == 3) {
			...
			$resbpkg .= '<div class="col-lg-7 col-md-7 col-xs-12">';
		}
		$resbpkg .= '
		...
		if ($sRec->type == 3) {
			...
			$resbpkg .= '<div class="col-lg-12 col-md-7 col-xs-12">
							<div class="col-md-4">
		...
		$resbpkg .= '</select>
    						        ...
    						        <div id="g-recaptcha-response" class="g-recaptcha" data-sitekey="6LfJi3IpAAAAADFACrwrLTyGei-eQMJsR6eS4yh_"></div>
