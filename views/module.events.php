				...
				$resevntdetail.='<div id="sidebar" class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="widget">
						...
						foreach($relevntRec as $relevntRow) {
							...
							$img_name = $imgRec[0];
							$resevntdetail.='<li> 
								<a href="'.BASE_URL.'events/detail/'.$relevntRow->slug.'"><img src="'.IMAGE_PATH.'events/'.$img_name.'" alt="events" />'.$relevntRow->title.'</a>
							    ...
							    <div class="blog-carousel">
							        <div class="entry">
							            <div class="flexslider">
							                ...
							                foreach($cimgRec as $k=>$cimgnm) {
							                    $resevntdetail.='<li><img src="'.IMAGE_PATH.'events/'.$cimgnm.'" alt="events" class="img-responsive"></li>';
							                }
							                $resevntdetail.='</ul>
							            	<!-- end slides --> 
							            </div>
