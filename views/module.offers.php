...
if(defined('OFFERS_PAGE') and isset($_REQUEST['slug'])) {
    ...
    if($recRow->offer_date > $currentdate){
      ...
      $offbredd.='<section class="breadcrumb-area overlay-dark-2 bg-2" style="background-image:url('.BASE_URL.'template/web/assets/images/about-img.jpg); background-repeat: no-repeat; background-size:cover; background-position-y: center;">
