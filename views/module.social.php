...
$resocl.='<ul class="contact-social">';
        if(!empty($socialRec)) {
        	foreach($socialRec as $socialRow) {                  		
        		$resocl.='<li>
		<a href="'.$socialRow->linksrc.'" target="_blank"><i class="'.$socialRow->image.'"></i></a></li>';    
            }
        }
        $resocl.='</ul>';
    ...
    <!--<div class="row disclaim">
        ...
        <div class="col-lg-12">
            ...
            <div class="widget-social-icons ">
                <ul>';
                foreach($socialRec as $socialRow) {
                    $ressl.='<li><a href="'.$socialRow->linksrc.'" target="_blank"><i class="'.$socialRow->image.'"></i></a></li>';
                }
                $ressl.='</ul>
            </div>
	    </div>
