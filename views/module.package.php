                ...
                <div class="wrapper-inner">
                    <div class="widget-features-grid">
                        ...
                        <div class="widget-title">
                            ...
                            <h2>Explore Riverbank Jungle Resort </h2>
                        </div>
                        <!-- Features Title End -->
...
// 			}
			...
			<div class="col-lg-4 col-sm-6">
                                    <div class="features-item" data-background="' . $imgpath . '">
        ...
        if (!empty($subpkgRec->feature)) {
            ...
            if (!empty($ftRec)) {
                ...
                foreach ($ftRec as $k => $v) {
                    ...
                    if (!empty($v[1])) {
                        $resubpkgDetail .= '<div class="ammenities-box box' . $k . '">
													<div class="row">
													    ';
                        foreach ($v[1] as $kk => $vv) {
                            $sfetname = Features::find_by_id($vv);
                            $img_path = SITE_ROOT . 'images/features/' . $sfetname->image;
                            $icon = (file_exists($img_path) and !empty($sfetname->image)) ? '<img width="28px;" style="margin-right:15px;" src="' . IMAGE_PATH . 'features/' . $sfetname->image . '" alt="' . $sfetname->title . '"/>' : '<i class="fa fa-check"></i>';
                            $resubpkgDetail .= '<div class="col-md-4 mb-20">
...
if (defined('FACILITIES_PAGE')) {
    ...
    if (!empty($subpkgRec)) {
        ...
        foreach ($subpkgRec as $k => $v) {
            ...
            $facility .= '<div class="col-sm-3 col-xs-6"><div class="etm">
	                    		 <div class="text-center"><img src="' . IMAGE_PATH . '/services/' . $img_nm[0] . '"/></div>
	                    		 <div class="text-center">' . $v->title . '</div>
	                    		 </div></div>';
        }
