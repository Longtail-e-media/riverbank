...
if(!empty($rmenuRec)) {
	...
	foreach($rmenuRec as $rmenuRow) {
        ...
        $resmr.='<li '.$rdrop1.'>';
        	$resmr.= getMenuList($rmenuRow->name, $rmenuRow->linksrc, $rmenuRow->linktype, $linkActive.$PlinkActive);
...
// Any mobile device.
if ($detect->isMobile()){
		/*$ret.='<div class="header-toggle">
	                <a href="javascript:;" id="navigate"><i class="fa fa-bars"></i></a>
	                '.$responsive.$result.'
	            </div>';*/
